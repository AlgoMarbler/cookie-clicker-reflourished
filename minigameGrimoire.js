...
M.launch=function()
{
	...
	M.init=function(div)
	{
		...
		M.computeMagicM=function()
		{
			...
			M.magicM=Math.floor(4+Math.pow(towers,0.6)+Math.log((towers+(lvl-1)*50)/15+1)*15);
			//old formula :
			/*
